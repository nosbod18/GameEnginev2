...
#define quatAdd  v4Add
#define quatSub  v4Sub
#define quatMul  v4Mul
#define quatDiv  v4Div

#define quatAddf v4Addf
#define quatSubf v4Subf
#define quatMulf v4Mulf
#define quatDivf v4Divf
